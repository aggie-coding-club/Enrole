    ...
    return GestureDetector(
      ...
      child: Stack(
        children: [
            ...
            children: [
              ...
              Expanded(
                child: PageView(
                  onPageChanged: (pageNum) async {
                    ...
                    if (!currentFocus.hasPrimaryFocus) {
                      ...
                      await Future.delayed(
                          Duration(milliseconds: 100), showPageControllers);
                    }
                    switch (pageNum) {
                      case 0:
                        {
                          setState(() {
                            currentPageControllers =
                                Page0Controllers(_pageController);
                      ...
                      case 1:
                        {
                          setState(() {
                            currentPageControllers =
                                Page1Controllers(_pageController);
                      ...
                      case 2:
                        {
                          setState(() {
                            currentPageControllers =
                                Page2Controllers(_pageController);
                  ...
                  children: [
                    GeneralInfoFormPage(
                      showPageControllers: showPageControllers,
                      hidePageControllers: hidePageControllers,
                      setName: setName,
                      setType: setType,
                      orgName: orgName,
                      orgType: orgType,
                    ...
                    OrgProfileFormPage(
                        ...
                        showPageControllers: showPageControllers),
                    VerifyPage(
                      homeCallback: this.widget.callback,
                      orgName: orgName,
                      orgType: orgType,
                      school: school,
                      imageFile: imageFile,
          ...
          currentPageControllers != null
              ? currentPageControllers as Widget
              : Container(),
        ],
      ),
    );
